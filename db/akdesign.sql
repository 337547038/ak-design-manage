...
CREATE TABLE `ak-demo-test` (
  `id` int(10) NOT NULL,
  `text` varchar(50) DEFAULT NULL COMMENT 'null'
...
(21, 'demo测试', 'ak-demo-test', 0, 1, '2024-01-11 13:42:46', '2024-01-11 15:05:46', 1, 1, '', '[{\"name\":\"text\",\"type\":\"VARCHAR\",\"length\":\"50\",\"default\":\"\",\"remark\":\"\",\"empty\":true,\"label\":\"文本框\",\"filedType\":\"input\",\"search\":true}]');
...
(54, NULL, '未命名可视化大屏', 4, '{list:[{type:\"line\",position:{width:400,height:300,left:\"165px\",top:\"101px\"},option:{xAxis:{type:\"category\",data:[\"Mon\",\"Tue\",\"Wed\",\"Thu\",\"Fri\",\"Sat\",\"Sun\"]},yAxis:{type:\"value\"},grid:{left:0,top:0,right:0,bottom:30},series:[{data:[150,230,224,218,135,147,260],type:\"line\"}]},config:{optionsType:1}}],config:{width:\"1920px\",height:\"1080px\",background:\"#000\",style:\".a{color: red}\",primary:\"#409eff\",method:\"post\",requestUrl:\"sourceList\"}}', NULL, NULL, '2023-12-24 22:24:29', '2023-12-24 19:00:04', NULL, NULL, 1, 1, NULL, NULL, NULL),
(55, 21, '未命名表单', 1, '{list:[{type:\"input\",control:{modelValue:\"\"},config:{},name:\"text\",formItem:{label:\"文本框\"}}],form:{size:\"default\"},config:{submitCancel:true},events:{beforeFetch:(data, route) =>\n{\n  // data请求参数，route当前路由信息\n  console.log(\'beforeFetch form\', data)\n  return data\n},afterFetch:(type, res) =>\n{\n  // 请求响应结果 \n  console.log(\'afterFetch form\', res)\n  return res\n},beforeSubmit:(data, route, model) =>\n{\n  // data提交的参数，route当前路由信息，当前表单值\n  console.log(\'beforeSubmit form\', data)\n  return data\n},afterSubmit:(type, data, res) =>\n{\n  // type(success,fail,validate),data响应数据,res响应结果\n  console.log(\'afterSubmit form\', data)\n  return data\n}}}', NULL, 1, '2024-01-12 13:24:51', '2024-01-11 16:55:28', '{}', NULL, 1, 1, NULL, NULL, NULL),
(56, 55, '未命名列表', 2, '{}', '{columns:[{label:\"多选\",type:\"selection\"},{label:\"序号\",type:\"index\",width:\"70px\"},{prop:\"text\",label:\"文本框\"},{label:\"操作\",prop:\"__control\"}],config:{openType:\"dialog\"},controlBtn:[{label:\"新增\",key:\"add\",type:\"primary\",size:\"small\",icon:\"plus\"},{label:\"导出\",key:\"import\",type:\"primary\",size:\"small\",icon:\"plus\"},{label:\"批量删除\",key:\"del\",type:\"danger\",size:\"small\",icon:\"delete\"}],operateBtn:[{label:\"编辑\",key:\"edit\"},{label:\"删除\",key:\"del\"}],events:{beforeFetch:(data, route) => {\n  // data请求参数，route当前路由信息\n  console.log(\'beforeFetch table\',data)\n  return data\n},afterFetch:(type, res) => {\n  // 请求响应结果 \n  console.log(\'afterFetch table\',res)\n  return res\n},beforeDelete:(data, route) => {\n  // data请求参数，route当前路由信息\n  console.log(\'beforeFetch table\',data)\n  return data\n}}}', NULL, '2024-01-12 15:15:48', '2024-01-11 17:03:57', '{}', NULL, 1, 1, NULL, NULL, NULL);
...
(51, 'admin', '0:0:0:0:0:0:0:1', NULL, '2024-01-11 13:17:16', 1),
(52, 'admin', '0:0:0:0:0:0:0:1', NULL, '2024-01-11 17:48:47', 1),
(53, 'admin', '0:0:0:0:0:0:0:1', NULL, '2024-01-12 10:35:37', 1),
(54, 'admin', '0:0:0:0:0:0:0:1', NULL, '2024-01-12 11:13:14', 1);
...
(30, 1, '未命名列表', 'icon-apply', 0, '/design/list/content/56', 1, '', 3, 1);
...
(1, 'admin', '管理员', '13800138000', 1, '1', '123456', 2, 0, '', NULL, NULL, '2024-01-12 11:13:14', 76, '0:0:0:0:0:0:0:1'),
