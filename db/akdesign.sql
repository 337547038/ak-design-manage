...
INSERT INTO `login_log` (`id`, `userName`, `loginIp`, `remark`, `dateTime`, `status`) VALUES
...
INSERT INTO `menu` (`id`, `parentId`, `name`, `icon`, `sort`, `path`, `status`, `remark`, `type`, `navShow`) VALUES
