...
public class DatasourceController {
    ...
    @PostMapping("get")
    public ResponseEntity<Datasource> queryById(@RequestBody Map<String, Integer> query) {
        return ResponseEntity.ok(this.datasourceService.queryById(query.get("id")));
    }
