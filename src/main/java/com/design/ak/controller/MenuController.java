...
public class MenuController {
    ...
    @Operation(summary = "根据当前登录用户返回对应菜单")
    @Parameter(name = "query", description = "查询条件")
    @PostMapping("listByUser")
    public ResponseEntity<Map<String, Object>> queryByUserId(@RequestBody Map<String, Object> pages) {
        return ResponseEntity.ok(this.menuService.queryByUserId(pages));
    }
